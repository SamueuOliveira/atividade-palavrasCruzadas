...
function v1() {
    ...
    if (i == word.length) {
        for (var o = 0; o < x.length; o++) {
            x[o].style.backgroundColor = '#01A020';
            x[o].disabled = true;
            btn_1.disabled = true;
        }
...
// Threads
function v17() {
    var word = ['T', 'H', 'R', 'E', 'A', 'D', 'S'];
    var palavra = [];
    var i = 0;
    var x = document.getElementsByClassName("question17");
    for (var l = 0; l < x.length; l++) {
        palavra += [x[l].value.toUpperCase()];
    }
    for (var c = 0; c < word.length; c++) {
...
function v18() {
    ...
    var palavra = [];
    var i = 0;
    var x = document.getElementsByClassName("question18");
    for (var l = 0; l < x.length; l++) {
        palavra += [x[l].value.toUpperCase()];
    }
    for (var c = 0; c < word.length; c++) {
